...
During my time at Deezer, from 2018 to 2024, I conducted research on Machine/Deep Learning, Graph Representation Learning, Information Retrieval, and Recommender Systems as part of the <a href='https://research.deezer.com/' target='_blank'><b>Research team</b></a> in France. From 2023 to 2024, I also coordinated scientific initiatives with engineers deploying music recommendation algorithms on the service. Previously, from 2016 to 2018, I worked as a Data Scientist in the company, collaborating with cross-functional teams to enhance the user experience.<br><br>

My research has led to <a href="https://scholar.google.fr/citations?hl=fr&authuser=1&user=BFT8u-oAAAAJ" target="_blank"><b>over 30 scientific publications</b></a> in peer-reviewed journals and international conferences, earning best paper awards or honorable mentions at RecSys 2020, 2021, 2024, and ECIR 2024. Several of these publications describe Machine Learning algorithms and Recommender Systems now <a href="https://deezer.com/" target="_blank"><b>used in production at Deezer</b></a>, helping millions of people discover and enjoy new music daily.<br><br>

My Ph.D. at École Polytechnique, completed between 2018 and 2022, was conducted alongside my work at Deezer, thanks to a scientific partnership between the two organizations. Supervised by <a href="https://scholar.google.fr/citations?user=e-aOrHAAAAAJ" target="_blank"><b>Romain Hennequin</b></a> and <a href="https://scholar.google.fr/citations?user=aWGJYcMAAAAJ" target="_blank"><b>Michalis Vazirgiannis</b></a>, my doctoral research focused on Representation Learning with Graph Neural Networks and Applications to Recommendation.<br><br>

I previously graduated in 2016 from <a href="https://www.master-mva.com/" target="_blank"><b>ENS Paris-Saclay</b></a> with a M.Sc. in Machine Learning (Master MVA), and from <a href="https://www.ensae.fr/en/" target="_blank"><b>ENSAE Paris</b></a> with a M.Eng. in Data Science, both with first-class honours.<br><br> 

I am always eager to connect and share experiences, so feel free to reach out.<br><br> 
